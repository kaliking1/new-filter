...
PICS = (environ.get('PICS', 'https://telegra.ph/file/d8d2c077be3da2a81b513.jpg')).split()
...
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '1742013609').split()]
...
DOWNLOAD_TEXT_URL = "https://t.me/Backupchannel12/5"

   # Custom Caption Under Button #
CAPTION_BUTTON = "MAIN GROUP"
CAPTION_BUTTON_URL = "https://t.me/pullingomovierequest"
