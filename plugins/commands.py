...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            [
                InlineKeyboardButton('⚡ UᎮDΛTΞS ⚡', url='https://t.me/tamilfilmography1')
            ],
            [
                InlineKeyboardButton('⚡ GROUP ⚡', url=f"https://t.me/pullingomovierequest"),
            ],
            [
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('⚡ GROUP ⚡', url='https://t.me/pullingomovierequest'),
            InlineKeyboardButton('🤖 UᎮDΛTΞS 🤖', url='https://t.me/tamilfilmography1')
            ],[
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('CHANNEL', url='https://t.me/tamilfilmography1') ] ] ),
        protect_content=True if pre == 'filep' else False,
        )
